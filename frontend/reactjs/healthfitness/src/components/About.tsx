    ...
    <div className="offcanvas-menu-wrapper">
        ...
        <nav className="canvas-menu mobile-menu">
            <ul>
                ...
                <li><a href="./classNamees.html">ClassNameclassNamees</a></li>
                <li><a href="./services.html">Services</a></li>
                <li><a href="./team.html">Our Team</a></li>
                <li><a href="#">Pages</a>
                    <ul className="dropdown">
                        <li><a href="./about-us.html">About us</a></li>
                        <li><a href="./className-timetable.html">ClassNameclassNamees timetable</a></li>
                ...
                <div className="col-lg-6">
                    <nav className="nav-menu">
                        <ul>
                            ...
                            <li><a href="./className-details.html">ClassNameclassNamees</a></li>
                            <li><a href="./services.html">Services</a></li>
                            <li><a href="./team.html">Our Team</a></li>
                            <li><a href="#">Pages</a>
                                <ul className="dropdown">
                ...
                <div className="col-lg-2 col-md-3 col-sm-6">
                    <div className="fs-widget">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Blog</a></li>
                            <li><a href="#">ClassNameclassNamees</a></li>
